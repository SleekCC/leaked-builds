...
public class BlurUtil {
    ...
    public static ShaderUtil gaussianProgram = new ShaderUtil("sleek/shader/blur.frag");
    ...
    public static void renderGaussianBlur(final float radius, final float compression, final boolean callEvent, final boolean backTrackBlurOnScreen) {
        ChatUtil.log(gaussianProgram.toString());
        ...
        if (callEvent) {
            ...
            Sleek.getInstance().getEventBus().post(eventBlur);
        }
