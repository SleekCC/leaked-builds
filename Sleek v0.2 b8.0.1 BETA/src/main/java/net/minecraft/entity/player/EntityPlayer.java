...
import today.sleek.client.modules.impl.visuals.HitEffect;
            ...
            if (!targetEntity.hitByEntity(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag2) {
                        ...
                        HitEffect hitEffect = Sleek.getInstance().getModuleManager().getModuleByClass(HitEffect.class);

                        if (flag || (hitEffect.crit.getValue() && hitEffect.isToggled())) {
                            for (int k = 0; k < hitEffect.critnum.getValue(); k++)
                                this.onCriticalHit(targetEntity);
                        }

                        if (f1 > 0.0F || (hitEffect.ench.getValue() && hitEffect.isToggled())) {
                            for (int k = 0; k < hitEffect.enchnum.getValue(); k++)
