...
@ModuleData(
        ...
        description = "Allows you to attack entities further than killaura can"
)
public class TPAura extends Module {
    ...
    public ModeValue mode = new ModeValue("Mode", this,"Smart");
    ...
    public NumberValue<Double> swingrage = new NumberValue<>("Swing Range", this, 3.0, 1.0, 100.0, 0.1);
    public NumberValue<Double> autoblockRange = new NumberValue<>("Block Range", this, 3.0, 1.0, 12.0, 0.1);
    public NumberValue<Double> cps = new NumberValue<>("CPS", this, 1.0, 0.1, 5.0, 0.1);
    ...
    private boolean attack(EntityLivingBase entity, double chance, String blockMode) {
        ...
        if (FightUtil.canHit(chance / 100)) {
            ...
            for (Vec3 vec : path) {
                PacketUtil.sendPacketNoEvent(new C03PacketPlayer.C04PacketPlayerPosition(vec.getX(), vec.getY(), vec.getZ(), mc.thePlayer.onGround));
            }
